...
async function enviarFormulario() {
    ...
    const alunoDTO = {
        ...
        "ra": document.querySelectorAll("input")[1].value,              // RA (Registro Acadêmico) do aluno
        ...
        "email": document.querySelectorAll("input")[4].value,           // E-mail do aluno
        "telefone": document.querySelectorAll("input")[5].value         // Telefone do aluno
    }
    ...
    try {
        ...
        const respostaServidor = await fetch("http://localhost:3333/novo/aluno", {
            ...
            body: JSON.stringify(alunoDTO)        // Converte o objeto alunoDTO em uma string JSON para enviar
        });
